export default function CodeBox({ title, properties, className }) {
    return (
        <div className={`rounded hidden md:flex border-[1px] flex-col gap-2 border-[#B91DFF]/10 bg-blend-soft-light backdrop-blur-md bg-pros px-6 py-3 pr-16 absolute ${className}`}>
