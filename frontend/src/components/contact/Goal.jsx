...
export default function Goal({ setInfo }) {
    ...
    return (
        <div className={`relative flex flex-col z-20 justify-center ${inputStyles}`}>
            ...
            <input className='bg-transparent select-none outline-none cursor-pointer font-medium transition duration-300 relative z-20 translate-y-[30%]' readOnly required autoComplete="off" onClick={() => setActive(prev => !prev)} type="text" id='goal' value={input} />
